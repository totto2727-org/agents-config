...
The shared `totto2727-org/monorepo/.github/actions/publish-crate@main` composite action owns version lookup and publication.
...
The action is maintained in the shared monorepo and has no repository-specific crate name or path.
